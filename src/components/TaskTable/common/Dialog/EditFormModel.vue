    ...
    <section class="cel-from-header" v-if="showForm == 0">
      ...
      >
        <template v-for="item in tabMenu">
                          ...
                          <el-form label-position="right" label-width="60px">
                            ...
                            >
                              ...
                              <el-select
                                ...
                                placeholder="配置类型"
                                style="width: 36.5%;margin-left:52px;"
                              >
                                <el-option
                            ...
                            >
                              ...
                              <el-select
                                ...
                                @change="changeItemType(item)"
                                placeholder="值类型"
                                style="width: 36.5%;margin-left:45px;"
                              >
                                <el-option
                              ...
                              >
                                ...
                                >
                                  ...
                                  <el-input
                                    ...
                                    v-model="item.val"
                                    clearable
                                    style="width:35%;margin-left:6px;"
                                  ></el-input>
                                  <el-input
                                    class="inputStyle"
                                    type="input"
          ...
          >
            <span slot="label">
              <i class="el-icon-d-caret" style="position:relative;"></i>
              <el-dropdown
                placement="bottom"
            ...
            >
              ...
              >
                <el-tab-pane class="firstPanel" label="常规配置" name="first">
                  <section>
                    <template v-if="page.val_type !== 'json'">
                      <draggable
                        class="list-group"
                        tag="ul"
                            ...
                            <el-form label-position="right" label-width="60px">
                              ...
                              >
                                ...
                                <el-select
                                  ...
                                  placeholder="配置类型"
                                  style="width: 36.5%;margin-left:53px;"
                                >
                                  <el-option
                                    v-for="item in cfgTypes"
                                    :key="item.value"
...
export default {
  ...
  methods: {
    ...
    changePageItemType(item) {
      if (item.cfg_type === "json" || item.cfg_type === "text") {
        // item.default = null;
        if (item.properties) {
          this.$delete(item, "properties", "enum");
        }
      } else {
        item.properties = [];
        if (item.default) {
