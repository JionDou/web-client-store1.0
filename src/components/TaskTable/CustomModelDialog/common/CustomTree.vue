<template>
  <div id="sample">
    <div
      id="myDiagramDiv"
      style="background-color: #ddd; border: solid 1px black; height: 570px;"
    ></div>
    <el-row style="margin:10px">
      <el-col :span="24">
        <el-button size="mini" id="zoomToFit">缩放</el-button>
        <el-button size="mini" id="centerRoot">居中</el-button>
        <el-button size="mini" id="SaveButton" @click="save()"
          >JSON格式化</el-button
        >
        <el-button size="mini" @click="load()">加载</el-button>
      </el-col>
    </el-row>
    <div>
  ...
  methods: {
    initGo() {
      ...
      that.myDiagram.nodeTemplate.contextMenu = MAKE(
        ...
        MAKE("ContextMenuButton", MAKE(go.TextBlock, "删除角色"), {
          click: function(e, obj) {
            // reparent the subtree to this node's boss, then remove the node
            var node = obj.part.adornedPart;
            if (node !== null) {
              that.myDiagram.startTransaction("永久删除");
              ...
              that.myDiagram.commitTransaction("永久删除");
            }
          }
        }),
